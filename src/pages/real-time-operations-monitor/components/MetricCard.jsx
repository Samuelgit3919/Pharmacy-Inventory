        ...
        <div className={`p-4 rounded-md border transition-colors ${isDarkMode
            ...
            <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-2">
                    ...
                    <div className={`w-2 h-2 rounded-full ${getStatusLight()} ${status === 'active' || status === 'critical' ? 'animate-pulse' : ''
                        }`}></div>
                </div>
                {change !== 0 && (
            ...
            <div className="space-y-1">
                ...
                <div className={`text-xs font-medium ${isDarkMode ? 'text-gray-400' : 'text-text-secondary'
                    }`}>
                    {title}
                </div>
            </div>
