...
const RealTimeOperationsMonitor = () => {
    ...
    return (
        <div className={`min-h-screen transition-colors duration-300 ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-background text-text-primary'
            }`}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        {navigationItems?.map((item, index) => (
                            <Link
                                key={index}
                                to={item?.path}
                                className={`p-4 rounded-md border transition-colors ${isDarkMode
