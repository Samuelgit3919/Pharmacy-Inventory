                    ...
                    <tbody>
                        {filteredAndSortedData.map((item) => (
                            ...
                            >
                                ...
                                <td className="py-3 px-4">
                                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${item.category === 'Prescription' ? 'bg-primary/10 text-primary' : 'bg-secondary/10 text-secondary'
                                        }`}>
                                        {item.category}
                                    </span>
                                </td>
                                ...
                                <td className="py-3 px-4">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <div className="w-16 h-2 bg-gray-200 rounded-full">
                                            <div
                                                className={`h-full rounded-full ${item.currentStock <= item.minStock
                                                    ? 'bg-error'
