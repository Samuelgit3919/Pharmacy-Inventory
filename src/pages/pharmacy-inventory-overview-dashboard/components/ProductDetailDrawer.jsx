                        ...
                        <div className="card p-4">
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${product.category === 'Prescription' ? 'bg-primary/10 text-primary' : 'bg-secondary/10 text-secondary'
                                        }`}>
                                        {product.category}
                                    </span>
                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="w-full bg-gray-200 rounded-full h-3">
                                        <div
                                            className={`h-3 rounded-full ${product.currentStock <= product.minStock
                                                ? 'bg-error'
                        ...
                        <div className="card p-4">
                            ...
                            <div className="space-y-3">
                                <div className="flex justify-between">
                                    ...
                                    <span className={`font-medium ${daysUntilExpiry <= 7 ? 'text-error' :
                                ...
                                {daysUntilExpiry <= 30 && (
                                    <div className={`p-3 rounded-md ${daysUntilExpiry <= 7 ? 'bg-error/10 text-error' : 'bg-warning/10 text-warning'
                                        }`}>
