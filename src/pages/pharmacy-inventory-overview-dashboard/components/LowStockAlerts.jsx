                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center space-x-2 mb-2">
                                <Icon
                                    ...
                                    size={16}
                                    className={`${item.urgency === 'high' ? 'text-error' :
                                        item.urgency === 'medium' ? 'text-warning' : 'text-secondary'
                                        }`}
                                />
                                <span className={`text-xs font-medium px-2 py-1 rounded-full ${item.urgency === 'high' ? 'bg-error/10 text-error' :
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="w-full bg-gray-200 rounded-full h-2">
                                    <div
                                        className={`h-2 rounded-full ${item.urgency === 'high' ? 'bg-error' :
