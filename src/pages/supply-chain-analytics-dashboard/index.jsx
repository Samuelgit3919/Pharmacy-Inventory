                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center space-y-4 lg:space-y-0">
                        ...
                        <div className="flex items-center space-x-3">
                            <button
                                ...
                                className={`flex items-center space-x-2 px-3 py-2 rounded-md border transition-colors ${isBookmarkPanelOpen
                            ...
                            <button
                                ...
                                className={`flex items-center space-x-2 px-3 py-2 rounded-md border transition-colors ${isExportPanelOpen
                                    ? "border-primary bg-primary/10 text-primary" : "border-border hover:border-primary/50 text-text-secondary hover:text-primary"
                                    }`}
                            >
                    ...
                    <div className="border-b border-border">
                        <div className="flex overflow-x-auto">
                            <button
                                ...
                                className={`px-6 py-4 font-medium text-sm whitespace-nowrap transition-colors ${activeTab === "forecast"
                            ...
                            <button
                                ...
                                className={`px-6 py-4 font-medium text-sm whitespace-nowrap transition-colors ${activeTab === "reorder" ? "border-b-2 border-primary text-primary" : "text-text-secondary hover:text-primary"
                                    }`}
                            >
                                <div className="flex items-center space-x-2">
                            ...
                            <button
                                ...
                                className={`px-6 py-4 font-medium text-sm whitespace-nowrap transition-colors ${activeTab === "seasonal" ? "border-b-2 border-primary text-primary" : "text-text-secondary hover:text-primary"
                                    }`}
                            >
                                <div className="flex items-center space-x-2">
