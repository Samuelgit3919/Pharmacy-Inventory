            ...
            <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-2">
                    <button
                        ...
                        className={`px-2 py-1 text-xs rounded-md transition-colors ${sortBy === "reliability" ? "bg-primary/10 text-primary" : "text-text-secondary hover:bg-background"
                            }`}
                    >
                        Reliability
                        {sortBy === "reliability" && (
                    ...
                    <button
                        ...
                        className={`px-2 py-1 text-xs rounded-md transition-colors ${sortBy === "costEfficiency" ? "bg-primary/10 text-primary" : "text-text-secondary hover:bg-background"
                            }`}
                    >
                        Cost
                    ...
                    <button
                        ...
                        className={`px-2 py-1 text-xs rounded-md transition-colors ${sortBy === "leadTime" ? "bg-primary/10 text-primary" : "text-text-secondary hover:bg-background"
                            }`}
                    >
                        Lead Time
                        {sortBy === "leadTime" && (
