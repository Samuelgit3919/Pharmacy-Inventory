                            ...
                            <div>
                                ...
                                <div className="space-y-2 mb-6">
                                    <button
                                        ...
                                        className={`w-full flex items-center justify-between px-3 py-2 text-sm rounded-md transition-colors ${localComparisonMode === "mom" ? "bg-primary/10 text-primary border border-primary" : "hover:bg-background border border-border"
                                            }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`w-full flex items-center justify-between px-3 py-2 text-sm rounded-md transition-colors ${localComparisonMode === "yoy" ? "bg-primary/10 text-primary border border-primary" : "hover:bg-background border border-border"
                                            }`}
                                    >
