            ...
            <div className="flex flex-wrap items-center justify-between mb-4">
                <div className="flex items-center space-x-2 mb-2 sm:mb-0">
                    ...
                    <button
                        ...
                        className={`px-3 py-1.5 text-sm rounded-md transition-colors ${viewMode === "monthly" ? "bg-primary/10 text-primary" : "text-text-secondary hover:bg-background"
                            }`}
                    >
                        Monthly
                    </button>
                    <button
                        ...
                        className={`px-3 py-1.5 text-sm rounded-md transition-colors ${viewMode === "quarterly" ? "bg-primary/10 text-primary" : "text-text-secondary hover:bg-background"
                            }`}
                    >
                        Quarterly
                    </button>
