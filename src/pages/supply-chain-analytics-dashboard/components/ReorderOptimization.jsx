            ...
            <div className="flex flex-wrap items-center justify-between mb-4">
                <div className="flex items-center space-x-2 mb-2 sm:mb-0">
                    <button
                        ...
                        className={`px-3 py-1.5 text-sm rounded-md transition-colors ${optimizationMode === "balanced" ? "bg-primary/10 text-primary" : "text-text-secondary hover:bg-background"
                            }`}
                    >
                        Balanced
                    </button>
                    <button
                        ...
                        className={`px-3 py-1.5 text-sm rounded-md transition-colors ${optimizationMode === "cost" ? "bg-primary/10 text-primary" : "text-text-secondary hover:bg-background"
                            }`}
                    >
                        Cost-Focused
                    </button>
                    <button
                        ...
                        className={`px-3 py-1.5 text-sm rounded-md transition-colors ${optimizationMode === "availability" ? "bg-primary/10 text-primary" : "text-text-secondary hover:bg-background"
                            }`}
                    >
                ...
                <div className="flex items-center space-x-2">
                    <button
                        ...
                        className={`px-2 py-1 text-xs rounded-md transition-colors ${sortBy === "savings" ? "bg-primary/10 text-primary" : "text-text-secondary hover:bg-background"
                            }`}
                    >
                        Savings
                        {sortBy === "savings" && (
                    ...
                    <button
                        ...
                        className={`px-2 py-1 text-xs rounded-md transition-colors ${sortBy === "risk" ? "bg-primary/10 text-primary" : "text-text-secondary hover:bg-background"
                            }`}
                    >
                        Risk
                        {sortBy === "risk" && (
